...
show_site="no"  # display the name of the source
use_colors="no"  # for error/warning
...
module_dir=${HOME}/.config/polybar/news
module_obj_dir=${HOME}/.cache/polybar/news/obj
